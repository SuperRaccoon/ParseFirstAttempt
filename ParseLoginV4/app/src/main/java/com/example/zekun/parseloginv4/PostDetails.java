...
/*
        ...
        findViewById(R.id.messageButton).setOnTouchListener(mDelayHideTouchListener);
*/
        Button postButton = (Button) findViewById(R.id.messageButton);
    ...
    protected void newPost(){
        ...
        String myMessage1 = myMessageEditText.getText().toString();
        String myMessage = myMessage1;
        ParseUser currentUser = ParseUser.getCurrentUser();
        currentUser.put("message", myMessage );
